...
class Sextant(object):
    ...
    def Calculate(self):
        ...
        self.table.append([f"Dip at eye height {self.eye_height}m", f"{deg_to_dm(-dip_of_horizon)}"])
...
if __name__ == '__main__':
    ...
    print(f"Reported to be consistent within 0.07′ over the entire range from the zenith to the horizon.\n")
